...
class Card extends Component {
    render() {
        return (
            <div className="w-60 h-72 rounded-lg bg-slate-950/90 p-5 text-white relative overflow-hidden">
                ...
                <div className="footer absolute bottom-0 bg-sky-200 w-full py-4 left-0">
                    <button className="text-sky-900 p-4">
                        Donwload
                    </button>
                </div>
            </div>
