...
class Card extends Component {
    render() {
        return (
            <motion.div drag className="w-60 h-72 rounded-xl bg-slate-950/10 backdrop-blur-lg p-5 text-white relative overflow-hidden">
