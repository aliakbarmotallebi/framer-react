...
const Card = ({ isDownload }) => {
    return (
        <motion.div drag className="w-60 h-72 rounded-xl bg-white/10 backdrop-blur-sm p-5 text-white relative overflow-hidden">
            <button>
